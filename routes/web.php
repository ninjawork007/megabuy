...
Route::group(['prefix' => 'admin',  'middleware' => 'admin',  'namespace'=>'Admin'], function(){
    ...
    Route::post('product/ajaxAddProductAttr', 'ProductController@ajaxAddProductAttr');
    ...
    Route::any('general', 'GeneralController@index');
    Route::post('general/getLeafCategoryList', 'GeneralController@getLeafCategoryList');
    Route::get('general/getInfo/{id}/{root_id}', 'GeneralController@getInfo');
    Route::post('general/ajaxGetCategoryInfo/{id}', 'GeneralController@ajaxGetCategoryInfo');
    Route::post('general/ajaxSaveCategory', 'GeneralController@ajaxSaveCategory');
    Route::post('general/ajaxDeleteCategory', 'GeneralController@ajaxDeleteCategory');
    Route::post('general/ajaxSaveConfigs', 'GeneralController@ajaxSaveConfigs');

    Route::any('gallery', 'GalleryController@index');
    Route::any('gallery/downloadImgZip', 'GalleryController@downloadImgZip');

    Route::get('productexport','ExportController@productExport');
    Route::get('userexport','ExportController@userExport');

});

Route::get('pwdconfirm',function(){
...
Route::group(['prefix' => 'front',  'namespace'=>'Front'], function(){
    ...
    Route::post('sell/ajaxAddBrand', 'SellController@ajaxAddBrand');
    //cart route
...
Route::get('front/checkout/index', 'Front\CheckoutController@index');
...
Route::group(['prefix' => 'front/checkout', 'middleware' => 'user', 'namespace'=>'Front'], function(){
    ...
    Route::post('payunpaid','CheckoutController@payForUnpaid');
...
Route::group(['prefix' => 'front', 'middleware' => 'user', 'namespace'=>'Front'], function(){
    ...
    Route::post('my/messages', 'MyController@messages');
    Route::post('my/getMemoUserList', 'MyController@ajaxGetUserList');
    Route::post('my/sendMessage', 'MyController@ajaxSendMessage');
    ...
    Route::post('my/getMessage', 'MyController@ajaxGetMessage');
});
...
Route::post('sendemail','Front\HelpController@sendEmail');
