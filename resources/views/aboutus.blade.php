    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="livicon icon3" data-name="users" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Help & Contacts
            </div>
        </div>
    </div>
    @stop
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 wow bounceInLeft" data-wow-duration="5s">
                <h2><label>Welcome to MegaBuy</label></h2>
                <p class="font-16">We are working on Help Contents and will post them soon.</p>
                <p>You can email to <a href="javascript:void(0)" class="color-blue" onclick="showModal()">info@megabuy.online</a>  for asking services of MegaBuy</p>
            </div>
            ...
            <div class="col-md-3 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="thumbnail bg-white  text-center">
                    ...
                    <div class="caption">
                        ...
                        <br />
                        <div class="divide">
                            <a class="divider"> <i class="livicon" data-name="facebook" data-size="22" data-loop="true" data-c="#3a5795" data-hc="#3a5795"></i>
                            </a>
                            <a href="#"> <i class="livicon" data-name="twitter" data-size="22" data-loop="true" data-c="#55acee" data-hc="#55acee"></i>
                            </a>
                            <a href="#"> <i class="livicon" data-name="google-plus" data-size="22" data-loop="true" data-c="#d73d32" data-hc="#d73d32"></i>
            ...
            <div class="col-md-3 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="thumbnail bg-white text-center">
                    ...
                    <div class="caption">
                        ...
                        <br />
                        <div class="divide">
                            <span onclick="showModal()" class="divider"> <i class="livicon" data-name="facebook" data-size="22" data-loop="true" data-c="#3a5795" data-hc="#3a5795"></i>
                            </span>
                            <a href="#"> <i class="livicon" data-name="twitter" data-size="22" data-loop="true" data-c="#55acee" data-hc="#55acee"></i>
                            </a>
                            <a href="#"> <i class="livicon" data-name="google-plus" data-size="22" data-loop="true" data-c="#d73d32" data-hc="#d73d32"></i>
...
@section('footer_scripts')
    ...
    <script>
        ...
        function sendEmail(){
            ...
            $.post("{{url('/send_email')}}",param,function(res){
                if(res.status == 1){
