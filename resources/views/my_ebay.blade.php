...
@section('content')
    <div class="container">
        <div class="row ml-0 mr-0">
            <span class="font-20 color-black">MegaBuy: Summary</span><span class="color-blue font-14 ml-10">longlyov_90(0)</span>
                        ...
                        <div class="standard-wrapper" style="padding-bottom:40px;">
                            ...
                            <div class="row ml-0 mr-0">
                                ...
                                <div class="col-md-9 border-rect similar-item pt-10 pb-10" style="height:256px;">
                                    <p class="font-12 color-black bold">Similor sponsored items</p>
