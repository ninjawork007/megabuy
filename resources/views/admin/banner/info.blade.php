                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id = "infoForm" action="{{url("admin/banner/ajaxSaveInfo")}}" method = "post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="title" type="text" placeholder="Banner title" class="form-control" value = "{{$info['title']}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Link URL</label>
                                <div class="col-md-9">
                                    <input name="url"  placeholder="Link Url" class="form-control" value = "{{$info['url']}}"></div>
                            </div>
                            <div class = "form-group">
                                <label class="col-md-3 control-label" for="name">Banner Image</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name = "category" class = "form-control" value="{{$info['category']}}">
