...
<body>
    <header id="gh"  role="banner" class="gh-w gh-simpleH">
        @if(Sentinel::getUser())
            {!! getUserInfoJsonInput(Sentinel::getUser()->id) !!}
        @endif
        ...
        <tr>
            <td class="gh-td">
                <h1 id="gh-l-h1">
                    ...
                    <![endif]-->
                    <a href="{{url("/")}}" _sp="m570.l2586" id="gh-la" style = "overflow: visible;">
                        MegaBuy Logo
                        <img role="presentation" style="position: absolute;top: 1px;left: -36px;width: 170px;" alt="eBay Logo" src="{{asset("assets/img/logo.png")}}" id="gh-logo">
                    </a>
                </h1>
            </td>
            <td class="gh-td">
            ...
            <td class="gh-td-s">
                <table class="gh-tbl2" role="presentation">
                    ...
                    <tr>
                        ...
                        <td class="gh-td" id="gh-cat-td" style = "position:relative">
                            <div id="gh-cat-box" >
                            ...
                            <i class = "fa fa-angle-down" style = "position: absolute;right: 11px;top: 14px;pointer-events: none;" />
                        </td>
                        <td class="gh-td gh-sch-btn"><input type="submit" class="btn btn-prim gh-spr" id="gh-btn" value="Search" onclick="onSearchProduct();"></td>
                        <td class="gh-td" id="gh-as-td"><a title="Advanced Search" href="{{url("/front/all_categories/0")}}" _sp="m570.l2614" id="gh-as-a">See All Categories</a></td>
                    </tr>
                    </tbody>
                </table>
            </td>
    ...
    <div id="gh-top" class="gh-hide-if-nocss"role="navigation" aria-label="Account">
            ...
            <li class="gh-t" id="gh-eb-u">
                <span id="gh-ug" class="gh-ug-guest" aria-expanded="false">
                    ...
                    @else
                        ...
                        <a class = "color-sign-a" href="{{url("/register_business")}}" _sp="m570.l2621">register</a>
                        </span>
                    @endif
                </span>
            </li>
        ...
        <ul id="gh-eb">
            ...
            <li id="gh-eb-My" class="gh-eb-li gh-dd rt hidden" data-imp="10">
                <div class="gh-menu">
                    <a href1="/" class="gh-eb-li-a">My MegaBuy</a>
            ...
            <li id="gh-eb-My" class="gh-eb-li gh-dd rt" data-imp="10" style="margin-top:6px;">
                <div class="gh-menu">
                    <a class = "color-black" style = "font-size:12px;" href = "{{url("front/my/activity_index")}}">My MegaBuy</a>
                </div>
            </li>
            @if(Sentinel::getUser())
    ...
    <div id="hlGlobalFooter" style="background-color:#004466;"><!--[if lt IE 9]>
        <div id="glbfooter" role="contentinfo" class="gh-w gh-flex"><![endif]-->
        <footer id="glbfooter" style="background-color:#004466;" role="contentinfo" class="gh-w">
            {{-- <div>
            ...
            <div>
                ...
                <table>
                    <tbody>
                        <tr valign="top">
                            <td>
                            <a href="{{url('/')}}"><img src="{{asset('assets/img/logo.png')}}" style="width:150px;margin-right:100px !important;"alt=""></a>
                            </td>
                            <td style="padding-top:15px;">
                                <a href="{{url('aboutus')}}" class="color-white" style="font-size:16px;margin-right:100px;">About Us</a>
                            </td>
                            <td style="padding-top:15px;">
                                <a href="" class="color-white" style="font-size:16px;margin-right:100px !important;">How It Works</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div>
                <table style="margin-top:30px; margin-left:10px;">
                    <tbody>
                    <tr valign="top" >
                        <td class="color-white" >Copyright © 2019 MegaBuy Inc. All Rights Reserved. 
                        </td>
                    </tr>
                    </tbody>
                </table>
