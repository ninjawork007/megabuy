...
@section('content')
                    ...
                    <div class="col-md-10 my-ebay-content col-xs-12 pl-0 pr-0 active" >
                        ...
                        <div class="bg-white-wrapper row ml-0 mr-0">
                            ...
                            <div class="col-md-6 pl-0 text-right ">
                                ...
                                <img class = "hidden" src="{{url("assets/img/mastercard.png")}}}" style="width:30px;">
                                <input type="radio" class = "hidden" name = "pay_type" value = "1" style = "vertical-align: middle;">
                                <img class = "hidden" src="{{url("assets/img/paypal2.png")}}" style="width:30px;">
                                <input  class = "hidden" type="radio" name = "pay_type" value = "2" style = "vertical-align: middle;">
                                <img  class = "hidden" src="{{url("assets/img/american-express.png")}}" style="width:30px;">
    ...
    <script>
        ...
        function onPayUnpaidOrder(){
            ...
            var pay_type = 0;
            confirmMsg("Are you sure to pay for the checked orders?", function(){
