    ...
    <div class = "order-wrapper border-bottom">
        <div class="row ml-0 mr-0 mt-20">
            ...
            <div class="col-md-6 text-right">
                <div class="display-inline ml-10 top-align">
                    <p class="bold color-black font-13 mb-0 text-right">Order time:{{$order['order_time']}} </p>
        ...
        <div class="row ml-0 mr-0">
            <div class="col-md-3 border-rect pt-10 pb-10">
                <div class="row ml-0 mr-0 text-center mt-10"><a href="{{url('front/product').'/'.$order_detail['product']['id']}}"><img src="{{correctImgPath($order_detail['product']['img'])}}" class="size-150"></a></div>
                ...
                <a href="{{url('front/product_list').'/'.$order_detail['product']['category_id']}}">
                    <p class="font-12 bold" style = "word-break: break-all;">
                        @foreach ($categories as $category)
                            @if($category['id'] == $order_detail['product']['brand_id'])
                                {{$category['title']}}
                            @endif
                        @endforeach
                    </p>
