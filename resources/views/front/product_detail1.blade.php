            ...
            <div class="tabbable-line">
                <ul class="nav nav-tabs hidden">
                    <li class="active brand-tab">
                        <a href="#brand1" class="bg-white brand-link" data-toggle="tab"> Your Pick ${{$productInfo->getProductPagePrice()}}</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="brand1">
                        ...
                        <div class="col-md-4 col-xs-12 mt-10">
                            ...
                            <div class="row ml-0 mr-0"><span class="font-30 color-black bold" id="product-price">{{$productInfo->getProductPagePrice()}}</span> @if($productInfo['retail_price']*1 !=0)<del style="margin-left: 30px;color: darkred;" class="font-16">$ {{$productInfo['retail_price']}}</del>@endif</div>
                            <div class="row ml-0 mr-0"><span class="font-14 bold ">Shipped: {{$productInfo['sell_count']}}</span></div>
                            <div class="row ml-0 mr-0"><span class="font-14 bold ">Remain: {{$productInfo['quantity']-$productInfo['sell_count']}}</span></div>
                            <ul class="product-condition-wrapper " >
                                <li style = "list-style: none;">
                                    <a href="{{url('front/product_list').'/'.$productInfo['brand_id']}}">{!! $productInfo->getBrandHtml() !!}</a>
                                </li>
                                @if($productInfo["condition"] != 0)
                                    <li>
                        ...
                        <div class="float-left pr-10">
                            <a href = "{{url("front/product/".$item['id'])}}" class = "none-underline"  >
                                ...
                                <div class = "row ml-10 mr-0 font-bold font-13">
                                    ...
                                    <a href="{{url('front/product_list').'/'.$item['brand_id']}}">
