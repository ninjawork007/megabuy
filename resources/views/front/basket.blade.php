        ...
        <div class="row ml-0 mr-0 mt-10">
            <div class="col-md-8 col-xs-12 pl-0 mt-10">
                        ...
                        @if(is_numeric($key))
                            <div class="standard-wrapper">
                                <div class="row ml-0 mr-0 pb-10 border-bottom">
                                    <a href="{{url('front/seller_product_list').'/'.$item[0]['seller']['id']}}"><span class="font-18 color-blue bold">Seller <u>{{$item[0]['seller']['first_name']}}@if($item[0]['seller']['first_name'] != "")  @endif {{$item[0]['seller']['last_name']}}</u></span>
                                ...
                                @foreach($item as $key1 => $item1)
                                    <div class="row ml-0 mr-0 mt-10 border-bottom">
                                        <div class="col-md-6 col-xs-12 pl-0 pr-0" style="float:left;">
                                            ...
                                            <div class="float-left pl-10 product-detail-md mt-10">
                                                <div class="row ml-0 mr-0">
                                                    <span class="color-black font-16 bold">{{$item1['title']}}</span>
                                                </div>
                                                <div class="row ml-0 mr-0">
                                                    <span class="font-14">{{$item1['subtitle']}}</span>
                                                </div>
                                                <div class="row ml-0 mr-0 mt-10">
                                                    <span class="font-14">{{$item1['varirant_str']}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12 pl-0 pr-0 mt-10">
                                            ...
                                            <div class="col-xs-6 pl-0 pr-0">
                                                <div class="row ml-0 mr-0 width-100">
                                                    <span class="font-18 bold color-black pull-right">AUD ${{$item1['totalPrice']}}</span>
                                                </div>
                                                <div class="row ml-0 mr-0 mt-10 width-100">
                                                    <span class="font-12 pull-right">Shipping Fee Included</span>
                                                </div>
                ...
                <div class="standard-wrapper mt-20">
                    ...
                    <div class="row ml-0 mr-0 mt-10">
                        <div id = "relationSlick" style = "height:250px;">
            ...
            <div class="col-md-4 col-xs-12 mt-10">
                <div class="standard-wrapper">
                    ...
                    <div class="row ml-0 mr-0 mt-10">
                        ...
                        <span class="font-12 pull-right">AUD ${{$basketList['totalPrice']}}</span>
                    </div>
                    <div class="row ml-0 mr-0 pb-10 border-bottom mt-10">
                        <span class="font-12">Shipping <i class="fa fa-info-circle"></i></span>
                        <span class="font-12 pull-right">Included</span>
                    </div>
                    <div class="row ml-0 mr-0 mt-10">
                        <span class="font-16 bold">Total</span>
                        <span class="font-16 bold pull-right">AUD ${{$basketList['basketPrice']}}</span>
                    </div>
                </div>
            </div>
        </div>
