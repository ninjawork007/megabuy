...
@section('content')
    ...
    <div class="container sngl ds3 edp-crnew" id="sell-page-wrapper" >
        <div class="edp ">
            <div class="crnew-hd">
                <h1 class="fl-none" style="margin-top:10px;font-weight:bold;">Tell Us What You Want To Sell</h1>
            </div>
            ...
            <div id="editpane_cnta">
                <form id="editpane_form" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="hidden" name="state" >
                    @if($action == "update")
                    ...
                    <div class="inner-cnt">
                        ...
                        <div style="clear: both"></div>
                        <div class="hgh">
                            <h2 class="fl-none sec-t">Product Details</h2>
                            ...
                            <div>
                                <div class="def min" id="editpaneSect_Title" sec="1">
                                        <div id="editpane_category" target="1" class="sec-msk msk-cat">
                                                <div class="eic-wrap">
                                                    <div>
                                                        ...
                                                        <div class="mr255 browse">
                                                                ...
                                                                <div class="clbl"><span id="category-path-1" tabindex="0"
                                                                    ...
                                                                    <span class="eic-change">
                                                                        <a id="category-link-1" href="javascript:void(0);" onclick="onChangeCategory(1);" start="1">
                                                                            @if(isset($category)) 
                                                                                <span class="color-black" id="categoryText"> {{$category['path']}}</span><br/><br/>&nbsp; <span class="chg" fn="chgcat">Change Category</span>
                                                                            @else
                                                                                <span class="chg" fn="chgcat">Choose Category</span>
                                                                            @endif
                                                                        </a>
                                                            ...
                                                            <p style="margin-top:10px;">&nbsp;&nbsp;If you don't find the proper category, <a href="javascript:void(0);" class="color-blue" onclick="showModal(this)">Email to Admin</a>.</p>
                                                        </div>
                                            ...
                                            <br/>
                                    <h2 class="reqd pad-t1" ><label style="margin-top:0px;" for="editpane_title">Title</label></h2>
                                    <div id="editpane_titlewrap" >
                                        ...
                                        <div class="bear-clear ar">
                                            ...
                                            <span id="titCount" class="cc"><b>75</b>Characters</span>
                                        </div>
                                        <div id="autofillMsg" class="aex-tt"></div>
                                    </div>
                                </div>
                                <div class="def min" id="editpaneSect_Subtitle" sec="1">
                                    <h2 class="pad-t1"><label for="editpane_subtitle">Subtitle</label>
                                        <span id="editpane_sttFee" class="fee-amt hidden">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <div class="bear-clear ar"><span id="subtitCount" class="cc"><b>55</b>Characters</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="def min" id="editpaneSect_condition" sec="1">
                                    ...
                                    <div id = "brand_wrapper">
                                        @include("front/product/brand_select")
                                    </div>
                                </div>
                                <div class="def min" id="editpaneSect_condition" sec="1">
                                    <h2 class="pad-t1">
                                ...
                                <div class="def" id="editpaneSect_Photo" sec="1">
                                    <div id="editpane_photos">
                                        ...
                                        <div id="editpane_pictureUrl">
                                            <div class="row ml-0 mr-0">
                                                <span>We recommend adding more than 2 photos</span>
                                ...
                                <div class="def" id="editpaneSect_ItemSpecific" sec="1">
                                    ...
                                    <div>
                                        <div>
                                            <div><span >If you don't see the attributes you are looking for, <a href="javascript:void(0);" class="color-blue" onclick="showModal(this)"> Email to Admin</a>.</span><br/></div>
                                            <div id="editpane_itmspc" is="1" target="1" class="sec-msk msk-is"style="margin-top:10px;">
                                                <fieldset>
                                                    <div>
                    ...
                    <div class="act-bar al" style = "background:white; padding:10px;">
                        <div class="row">
                            ...
                            <div class="tof" style = "padding-left:10px;">
                                    ...
                                    <div class="col-md-6">
                                        <p>* You need to check the checkboxes above to set the variants of products</p>
                                        <p>&nbsp;&nbsp;If you don't see the properties for variants, <a href="javascript:void(0);" class="color-blue" onclick="showModal(this)"> Email to Admin</a>.</p>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class = "mt-20">
                        <div class="large-btn btn-m-r20 btn-wr" id="actionbar">
                            <input type="button" value="List Product" class="pbtn bold" onclick = "saveProduct('1');"/>
                            <button type="button"  class="sbtn hidden" style = "display:none !important;">Preview</button>
                            <input type="button" value="Save as draft" class="sbtn" onclick="saveProduct('0');"/>
                            <a href="javascript:void(0);" onclick = "goDraft()" >Cancel</a>
    ...
    <div id="spinner" class="hidden" style="position:fixed;left:50vw;top:50vh;z-index:1;">
        <img src="{{asset('assets/img/giphy.gif')}}" style="width:100px;" alt="">
        <p class="bold" style="text-align:center;">Uploading...</p>
    </div>
    @include("front/product/customize_variant_dlg")
    @include("front/product/attr_model")
    @include("front/product/add_brand_dlg")
...
<script>
    ...
    function saveProduct(state){
        ...
        $("#editpane_form input[name='state']").val(state);
        $("#product_state").val(state);
    ...
    function customizeVariant(){
        ...
        if(curVariantAttrs.length ==0 || curVariantAttrs.length > 3 ){
            errorMsg("The properties for variants are not chosen.");
            return;
        }
        var param = new Object();
        param._token = _token;
    ...
    function sendEmail(){
        ...
        param.msg = $('#emailMsg').val();
        $.post("{{url('/sendemail')}}",param,function(res){
            if(res.status == 1){
                successMsg("The email is sent successfully.", function(){
