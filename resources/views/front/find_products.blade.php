    ...
    <div class="container">
        ...
        <div class = "col-xs-12 col-lg-10" style = "padding-left:40px; padding-right:20px;">
            ...
            <div class = "row find_product_wrapper ">
                ...
                <h3>{{$total_count}} items found MegaBuy international sellers</h3>
                <ul class = "find_product_ul">
                    ...
                    <li onclick="gotoProductDetail('{{$product['id']}}')" class="cursor">
                        <div class = "row">
                            ...
                            <div class = "col-xs-8">
                                <h3 class = "font-20">{{$product["title"]}}</h3>
                                <div class = "row" style = "margin-left:0px; margin-right:0px;">
                                    <span class = "product-detail font-16">
                                        {{$product["subtitle"]}}
                                    </span>
                                </div>
                                <div class = "row" style = "margin-left:0px; margin-right:0px; margin-top: 10px;">
                                    <div class = "col-xs-6">
                                        @if(isset($product["brand"]["title"]))
                                            <div class = "row">
                                                <span style = "font-size:16px;">Brand: {{$product["brand"]["title"]}}</span>
                                            </div>
                                        @endif
                                        <div class = "row">
                                    ...
                                    <div class = "col-xs-6">
                                        <div class = "row">
                                            @if( isset($product['seller']) && $product['seller']->isTopSeller())
                                            <i class = "fa fa-money" style = "color: #5a3610;"></i> Top Rated Seller
                                            @endif
                                        </div>

                                        <div class = "row mt-10">
                                            @if($location_country[$product['seller']['country']] != '')
                                            <span>From: {{$location_country[$product['seller']['country']]}}</span>
                                            @endif
                                        </div>
