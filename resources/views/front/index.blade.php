...
@section('content')
    <div class="container">
        ...
        <section class="purchas-main">
            ...
            <div class="hl-card-header hidden">
                <div class="hl-card-header__header-container clearfix">
            ...
            <div class="owl-carousel owl-theme hidden" id="carousel3">
            ...
            <div class="hl-module hl-popular-destinations off-card hl-atf-module-js" id="destinations_list1">
                ...
                @foreach($rootCategory as $root_category)
                <div class = "row ml-0 mr-0 mb-10">
                    ...
                    <div class = "categories-item-wrapper">
                        <ul class="sub-nav-box sp">
                            ...
                            <li><a href="{{url("front/product_list")}}/{{$leavedItem['id']}}">
                                    <div class = "home_category_img_wrapper">
                                        <img class = "home_category_img" src = "{{correctImgPath($leavedItem['img'])}}" onerror = "noExitImg(this)" />
                                    </div>
                                    <div style = "text-align:center; margin-top:10px;">
                                    {{$leavedItem['category_text']}}
                                    </div>
                                </a>
                            </li>
                            @endforeach
            ...
            <div class="hl-module hl-popular-destinations off-card hl-atf-module-js hidden" id="destinations_list2">
                <div class="hl-card-header">
                    <div class="hl-card-header__header-container clearfix">
                    ...
                    <h2 class="hl-custom-card__headline">
                        <a style="color:#d23608;" href="#">
                            <div style="color:#d23608;" class="ebayui-ellipsis-2">
                                <span style="color:#d23608;">Browse Products</span>
                            </div>
                        </a>
                    </h2>
                    <div class="hl-custom-card__subheadline secondary-text">
                        <div style="color:#d23608;" class="ebayui-ellipsis-2">
                            <span style="color:#d23608;"></span>
                        </div>
                    </div>
