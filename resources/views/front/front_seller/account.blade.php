                        ...
                        <div class="row margin_right_left">
                            <div class="col-md-12">
                                ...
                                <div class="position-center">
                                    ...
                                    <div>
                                        <h3 class="text-primary" id="title">Merchant: </h3>
                                    </div>
                                    <div class="form-group {{ $errors->first('merchant_id', 'has-error') }}">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" placeholder="Merchant Id "  name="merchant_id" class="form-control"
                                                   value="{!! old('merchant_id',$user->merchant_id) !!}">
                                        </div>
                                        <span class="help-block">{{ $errors->first('merchant_id', ':message') }}</span>
                                    </div>
                                    <div class="form-group {{ $errors->first('merchant_id', 'has-error') }}">
                                        <label class="col-lg-2 control-label">
                                            Security:
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" placeholder="Merchant Id "  name="merchant_security" class="form-control"
                                                   value="{!! old('merchant_security',$user->merchant_security) !!}">
                                        </div>
                                        <span class="help-block">{{ $errors->first('merchant_security', ':message') }}</span>
                                    </div>
                                    <div>
