...
@section('content')
            ...
            <div class="tab-content mt-10">
                <div class="tab-pane fade active in" id="activity">
                    ...
                    <div class="col-md-10 my-ebay-content col-xs-12 pl-0 pr-0 active">
                        <form id = "searchForm" action = "{{url("front/my/seller/activity_selling_product")}}" >
    ...
    <form method="POST" action="{{url('front/product/ajaxUpdateProductInfo')}}">
        ...
        <button type = "submit" class="hidden" id="offline" style = "width:90%; height:40px; line-height:40px;"><i class = "fa fa-lock"></i> </button>
    </form>
    <script>
        function setOfflineProduct(obj){
            confirmMsg("Are you sure to Offline this Product?", function(){
                setTimeout(function(){
